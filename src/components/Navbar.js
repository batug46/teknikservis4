                  ...
                  {isProfileOpen && (
                    <div className="absolute right-0 mt-2 w-64 rounded-xl bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-2 transform transition-all duration-200 ease-out origin-top-right will-change-transform">
                      {session.user.role === 'admin' && (
                        <Link href="/admin" className="flex items-center px-4 py-3 text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50/80 dark:hover:bg-blue-900/30 transition-all duration-150 ease-out rounded-lg cursor-pointer">
                          ...
                          <span className="transition-all duration-150 ease-out font-medium">Admin Paneli</span>
                        </Link>
                      )}
